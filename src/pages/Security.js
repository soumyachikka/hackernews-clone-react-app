        ...
        <tr>
          <td>
            ...
            <p>
              ...
              <ul>
                <li>
                  The minor version of bcrypt used for passwords was susceptible
                  to a collision in some cases.
                </li>
              </ul>
            </p>
            ...
            <p>
              ...
              <ul>
                <li>
                  The right-to-left override character could be used to obscure
                  link text in comments.
                </li>
              </ul>
            </p>
            ...
            <p>
              <b>
                2016-01-13:{" "}
                <a href="https://twitter.com/merttasci_">
                  Mert Ta&scedil;&ccedil;i
                </a>
              </b>
              <ul>
                <li>
            ...
            <p>
              ...
              <ul>
                <li>
                  An open redirect was possible by passing a URL with a
                  mixed-case protocol as the <em>goto</em> parameter.
                </li>
              </ul>
            </p>
            ...
            <p>
              ...
              <ul>
                <li>
                  ...
                  discover valid profile edit links and the user for which they
                  were valid.
                </li>
                <li>
            ...
            <p>
              ...
              <ul>
                <li>
                  In rare cases some users' profiles (including email addresses
                  and password hashes) were mistakenly published to the Firebase
                  API. More{" "}
            ...
            <p>
              ...
              <ul>
                <li>
                  Some pages displaying forms were vulnerable to reflected XSS
                  when provided malformed query string arguments.
                </li>
              </ul>
            </p>
            ...
            <p>
              <b>
                2014-05-01:{" "}
                <a href="https://titanous.com">Jonathan Rudenberg</a>
              </b>
              <ul>
                <li>
            ...
            <p>
              ...
              <ul>
                <li>
                  Incorrect handling of unauthenticated requests meant anyone
                  could change rsvp status for Demo Day.
                </li>
              </ul>
            </p>
            ...
            <p>
              ...
              <ul>
                <li>
                  Someone creating a new account could sometimes take an
                  existing username.
                </li>
              </ul>
            </p>
            ...
            <p>
              ...
              <ul>
                <li>
                  The state of the PRNG used to generate cookies could be
                  determined from observed outputs. This allowed an attacker to
                  fairly easily determine valid user cookies and compromise
                  accounts. More{" "}
