        ...
        <tr>
          <td>
            ...
            <p>
              ...
              software, software which demotes overheated discussions, and
            ...
            <p>
              Roughly, the number of upvotes on their stories and comments minus
              the number of downvotes. These don't match up exactly; some votes
              are dropped to prevent abuse.
            </p>
            <p>
            ...
            <p>
              ...
              users reach a certain karma threshold, but never on direct
              replies.
            </p>
            <p>
            ...
            <p>
              ...
              you want to submit a link with comments, just submit it, then add
              a regular comment.
            </p>
            <p>
            ...
            <p>
              Click on its timestamp to go to its page, then click the 'flag'
              link at the top. There's a small karma threshold before flag links
              appear.
            </p>
            <p>
              <b>Are reposts ok?</b>
            ...
            <p>
              When a story has had significant attention in the last year or so,
              we bury reposts as duplicates. If not, a small number of reposts
              is ok.
            </p>
            <p>
            ...
            <p>
              No, for the same reason. It's also not in your interest, because
              HN readers will figure it out, flag the thread, and use unkind
              words like 'spam'.
            </p>
            <p>
            ...
            <p>
              ...
              each month (or Jan 2). Most job ads are welcome there. But only an
              account called
              <a href="submitted?id=whoishiring">whoishiring</a> is allowed to
            ...
            <p>
              ...
              have been killed by software, moderators, or user flags.
            </p>
            <p id="cvouch">
              ...
              timestamp to go to its page, then click 'vouch' at the top.
            ...
            <p>
              ...
              site for maxvisit minutes at a time, with gaps of minaway minutes
              in between. The defaults are 20 and 180, which would let you view
              the site for 20 minutes at a time, and then not allow you back in
              for 3 hours.
            </p>
            <p>
            ...
            <p>
              If you have an email address in your profile, request a password
              reset <a href="https://news.ycombinator.com/forgot?id=">here</a>.
              If you haven't, email hn@ycombinator.com for help.
            </p>
            <p>
            ...
            <p>
              ...
              <table
                width="100%"
                style={{ width: "100%", backgroundColor: "#ff6600" }}
                cellPadding="0"
              >
                <tbody>
                  <tr>
